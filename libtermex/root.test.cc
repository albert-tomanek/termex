...
CScheme custom_cscheme = {
	TB_YELLOW, TB_RED, TB_MAGENTA, TB_CYAN,
	TB_GREEN, TB_BLUE, TB_WHITE, TB_BLACK,
	TB_MAGENTA, TB_BLUE, TB_CYAN, TB_WHITE
};
...
int main()
{
	...
	quitButton->cscheme = &custom_cscheme;
